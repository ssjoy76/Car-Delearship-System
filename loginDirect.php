...
<form action="loginDirect Action.php" method="post" enctype="multipart/form-data" id="Login">
  ...
  <div class="form-group">
     ...
     <div class="form-group">
       ...
       <input type="password" class="form-control" id="inputPassword" autocomplete="off" placeholder="Password" name="psw" Required maxlength="15">
     </div>
...
<button type="submit" class="btn btn-primary" name="submit" onclick="location.href='register.php'"> Register</button><br><br>
