    ...
    <div class="col-sm-12">
         ...
         <div class="col-sm-12">
             <div class="row">
                 ...
                 <div class="col-xs-8">
                     <input type="tel" name="phone" id="lname" placeholder="01xxxxxxxxx" class="form-control " autocomplete="off"  required pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" maxlength="11">
             </div>
              </div>
         </div>
...
<br>
 ...
 <div class="col-sm-12">
                  ...
                  <input type="submit" class="btn btn-primary"  id="lname" value="Back Login" onclick="location.href='loginUser.php'">
