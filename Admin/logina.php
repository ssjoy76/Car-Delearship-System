...
<form action="loginaAction.php" method="post" enctype="multipart/form-data" id="Login">
  
  <div class="form-group">
       <!-- <label for="email">Email</label> -->
       <input type="email" class="form-control" id="inputEmail" name="email" placeholder="xxxxx@xxx.com" Required>
     </div>
     <div class="form-group">
       <!-- <label for="password">Password:</label> -->
       <input type="password" class="form-control" id="inputPassword" name="psw"  placeholder="Password" Required maxlength="15">
     </div>
