...
$sql="SELECT * FROM `lohin` where adminId='$id'";
$dat=[];
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="dateOrderView.php">Date Order View</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="brandView.php">View Brand</a></li>
...
<li class="dropdown" style="margin-left: 500px; ">
          ...
          <a class="dropdown-toggle" data-toggle="dropdown" href="#"><?php echo $value['adminName']; ?> </a>
          <img src="<?php echo $value['pho']; ?>" style="height: 60px; width:60px;">
         <?php } ?>
        </li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="logouta.php"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
      </ul>
    </div>
  </div>
</nav>
