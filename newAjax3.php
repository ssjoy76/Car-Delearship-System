...
if(isset($_POST["brand_id"]))  
 { 
      ...
      {  
            $query  = "select * from gari where Mileage <='2000' AND New_old='New' ";  
      } 
      else if($_POST["brand_id"] == '5000')
      {  
             $query  = "select * from gari where Mileage >'2000' AND Mileage <='5000' AND New_old='New' "; 
      }
       else if($_POST["brand_id"] == '10000')
      {  
            $query  = "select * from gari where Mileage >'50000' AND Mileage <='10000' AND New_old='New'"; 
      }         
                 
      else if ($_POST["brand_id"] == '100000') 
      
      {  
            $query  = "select * from gari where Mileage>'10000' AND New_old='New'"; 
      }
      else{   $query  = "select * from gari where New_old='New'" ;   }       
